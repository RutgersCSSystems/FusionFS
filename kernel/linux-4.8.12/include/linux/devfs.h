...
/*
 * LevelDB append-CRC-write support 
 */
...
typedef struct _nvme_command_common {
    ...
    u64                     prp1;       ///< PRP entry 1
    u64                     prp2;       ///< PRP entry 2
    u64                     prp_vec[8];///< PRP entry for compound ops
    u64                     ret[8];///< PRP entry for compound ops
} nvme_command_common_t;
...
extern int op_log_data_fd;
extern struct file *op_log;
extern struct file *op_log_data;
#endif
