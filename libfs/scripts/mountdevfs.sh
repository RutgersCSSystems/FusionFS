...
sudo mount -t crfs -o physaddr=0x1400000000,init=60g none /mnt/ram	#starting at physical ram 80GB, size is 80GB
#sudo mount -t crfs -o physaddr=0x400000000,init=16g none /mnt/ram      #starting at physical ram 16GB, size is 16GB
